...
"""
@version: v1.0
@author: xag(原作者),lucifer11
@license: Apache Licence
@contact: lucifercaonima@gmail.com
@site: https://fdlucifer.github.io/
...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "fad1927194232511c6c3508950703dcb"
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            ...
            print('sorry，图片不是原图，没法获取到图片属性。')
            return ''

    def judge_time_met(self, take_time):
        """
        通知拍摄时间判断图片的拍摄时间是否在当天
        :param take_time:
        :return:
        """
        # 拍摄时间
...
if __name__ == '__main__':
    # 手机打开定位后拍摄的【原图】
    location = Location('/root/location/picture/test.jpg')
